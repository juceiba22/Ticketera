  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8 animate-fade-in">
      ...
      <div className="flex space-x-1 border-b border-neutral-800">
        ...
        <Link href={`/dashboard/eventos/${evento.id}/artistas`} className="px-4 py-3 border-b-2 border-white text-white font-medium">
          Artistas
        </Link>
      ...
      <div className="bg-neutral-900 border border-neutral-800 p-6 md:p-8 rounded-2xl space-y-6">
        ...
        <div className="space-y-4">
          {artistas?.map((artista) => (
            <form key={artista.id} action={editArtista} className="flex flex-col md:flex-row gap-4 items-end bg-neutral-950 p-4 rounded-xl border border-neutral-800">
              ...
              <div className="w-full md:w-1/3">
                <label className="block text-xs font-medium text-neutral-500 mb-1">Imagen URL</label>
                <input name="imagen_url" type="url" defaultValue={artista.imagen_url || ''} placeholder="https://..." className="w-full px-3 py-2 bg-neutral-900 rounded-lg border border-neutral-800 focus:outline-none focus:ring-1 text-white" />
              </div>
              
              <div className="flex gap-2 w-full md:w-auto">
                <button type="submit" className="flex-1 md:flex-none px-4 py-2 bg-white text-black font-semibold rounded-lg hover:bg-neutral-200 transition-colors">Guardar</button>
        ...
        <div className="pt-6 border-t border-neutral-800">
          ...
          <form action={addArtista} className="flex flex-col md:flex-row gap-4 items-end bg-neutral-950/50 p-4 rounded-xl border border-neutral-800 border-dashed">
            <input type="hidden" name="evento_id" value={evento.id} />
            ...
            <div className="w-full md:w-1/3">
              <label className="block text-xs font-medium text-neutral-500 mb-1">Imagen URL</label>
              <input name="imagen_url" type="url" placeholder="https://..." className="w-full px-3 py-2 bg-neutral-900 rounded-lg border border-neutral-800 focus:outline-none focus:ring-1 text-white" />
            </div>
            
            <button type="submit" className="w-full md:w-auto px-6 py-2 bg-white text-black font-semibold rounded-lg hover:bg-neutral-200 transition-colors">
              Agregar
            </button>
          </form>
        </div>
