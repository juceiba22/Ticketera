    ...
    <div className="min-h-screen flex items-center justify-center bg-black text-white p-6">
      <form className="max-w-sm w-full bg-neutral-900 p-8 rounded-2xl border border-neutral-800 shadow-xl space-y-6">
        <div className="text-center">
          ...
          <p className="text-neutral-400 mt-2 text-sm">Crea tu cuenta de productora</p>
        </div>
        ...
        <div className="space-y-4">
          <div>
            <label className="block text-sm font-medium text-neutral-400 mb-1" htmlFor="nombre">Nombre de la Productora</label>
            <input 
              id="nombre" 
              name="nombre" 
              type="text" 
        ...
        <button formAction={signup} className="w-full py-3 bg-white text-black font-semibold rounded-xl hover:bg-neutral-200 transition-colors">
